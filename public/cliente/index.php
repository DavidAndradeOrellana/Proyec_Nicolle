...
<div class="form-group">
              ...
              onkeyup="validacion('nombre'); " onkeypress="return sololetras(event)" required>
              ...
              <input id="apellido" name="apellido" type="text" class="form-control" placeholder="Ingrese un apellido "
               onkeyup="validacion('apellido'); "onkeypress="return sololetras(event)" required>
              <span class="help-block"></span>
                  </div>
                                </div>
                   ...
                   <div class="form-group">
                                   <label for="direccion" class="control-label col-xs-3">Direccion:</label>
                                    <div class="col-xs-5">
              <input id="direccion" name="direccion" type="text" class="form-control" placeholder="Ingrese una dirección " onkeyup="validacion('direccion'); " required>
              <span class="help-block"></span>
                  </div>
                                </div>
             <div class="form-group">
              ...
              onkeyup="validacion('telefono');" onkeypress="return aceptNum(event)" required>
              <span class="help-block"></span>
                  </div>
                                </div>
