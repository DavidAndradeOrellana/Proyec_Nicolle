...
include './conexion/coneccion.php';
include './Clases/Cliente.php';
include './Clases/clienteControlador.php';

$clienteA = new clienteControlador();

 if(isset($_REQUEST['bot'])){
             $clienteA->setIdcliente($_REQUEST['Idcliente']);
           $clienteA->setNombre($_REQUEST['nombre']);
            $clienteA->setApellido($_REQUEST['apellido']);
            $clienteA->setDireccion($_REQUEST['direccion']);
            $clienteA->setTelefono($_REQUEST['telefono']);
           $datosObj=array($clienteA->getIdcliente(),
                           $clienteA->getNombre(),
                           $clienteA->getApellido(),
                           $clienteA->getDireccion(),
                           $clienteA->getTelefono());
    print "<div id='dialogo' title='Exito' style='display: none;'>";
            print '<p>Mensaje: ';
            print $clienteA->modificarDatos($con,$datosObj);
