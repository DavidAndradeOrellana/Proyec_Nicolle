...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <script src="../../libreria/js/jquery-ui-1.10.4.custom.min.js"></script>
...
$Usuario = new UsuarioControlador();
        if(isset($_REQUEST['bot'])){
           ...
           $Usuario->setNombre($_REQUEST['Usuario']);
            $Usuario->setAdministrador($_REQUEST['contraseña']);
           $datosObj=array($Usuario->getIdUsuario(),
                           $Usuario->getNombre(),
                           $Usuario->getAdministrador());

               print "<div id='dialogo' title='Exito' style='display: none;'>";
            print '<p>Mensaje: ';
            print $Usuario->modificarDatos($con,$datosObj);
